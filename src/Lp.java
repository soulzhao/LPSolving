...
public class Lp {
    ...
    public static void main(String[] arg) {
        ...
        try {
            ...
            // Allocate memory
            ind = GLPK.new_intArray(3); // indices
            val = GLPK.new_doubleArray(3); // value
            ...
            GLPK.intArray_setitem(ind, 1, 1); // ary array, index index of the element, value new value
            GLPK.intArray_setitem(ind, 2, 2);
            
            GLPK.doubleArray_setitem(val, 1, 1.); // ary array, index index of the element, value new value
            GLPK.doubleArray_setitem(val, 2, -.5);
            
            GLPK.glp_set_mat_row(lp, 1, 2, ind, val); // 1 
            ...
            GLPK.glp_set_mat_row(lp, 2, 2, ind, val); // 2
